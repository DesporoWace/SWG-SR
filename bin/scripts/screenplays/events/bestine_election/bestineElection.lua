BestineElection = ScreenPlay:new {
	...
	electionDuration = 30 * 60 * 60 * 1000, -- Duration of the election phase
	timeTilNextElection = 30 * 60 * 60 * 1000, -- Time until next election, starts immediately after an election ends
