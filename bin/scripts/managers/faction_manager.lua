...
factionList = {
	...
	{ "norulac_raiders", true, "tdf", "", 1.0 },
	{ "taanab_looter", true, "tdf", "", 1.0 },
	{ "taanab_pirate", true, "tdf", "", 1.0 },
	{ "arcon_multinode", true, "taanab_pirate", "banthal_company,tdf", 1.0 },
	{ "banthal_company", true, "taanab_looter", "arcon_multinode,tdf", 1.0 },
	{ "tdf", true, "norulac_raiders,taanab_looter,taanab_pirate", "", 1.0 },
	{ "taanab_surveyor", true, "norulac_raiders", "tse_miner", 1.0 },
	{ "tse_miner", true, "hydro_station", "taanab_surveyor", 1.0 },
	{ "hydro_station", true, "tse_miner", "", 1.0 },
}
