...
object_tangible_component_bio_bio_component_clothing_field_intimidate = object_tangible_component_bio_shared_bio_component_clothing_field_intimidate:new {
	...
	experimentalSubGroupTitles = {"null", "null", "decayrate", "hitpoints", "@obj_attr_n:bio_comp_block", "cat_skill_mod_bonus.@stat_n:block", "@obj_attr_n:bio_comp_dodge", "cat_skill_mod_bonus.@stat_n:dodge"},
	experimentalMin = {0, 0, 30, 1000, 117, 2, 118, 2},
