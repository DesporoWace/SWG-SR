...
includeFile("tangible/component/weapon/lightsaber/lightsaber_module_end_game_crystal.lua")
...
includeFile("tangible/component/weapon/lightsaber/lightsaber_module_generic_pearl.lua")
