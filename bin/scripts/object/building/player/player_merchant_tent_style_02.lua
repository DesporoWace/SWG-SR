...
object_building_player_player_merchant_tent_style_02 = object_building_player_shared_player_merchant_tent_style_02:new {
	...
	shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/shop_sign_halloween_sign.iff", x = 3, z = -0.5, y = 3, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "crafting_merchant_management_04", suiItem = "@player_structure:halloween_standing_sign"},
		{templateFile = "object/tangible/sign/player/efol_standing_sign_01.iff", x = 3, z = -0.5, y = 3, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "sign_efol_standing", suiItem = "@player_structure:efol_sign_standing"},
	},
}
