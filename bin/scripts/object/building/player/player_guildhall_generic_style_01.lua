...
object_building_player_player_guildhall_generic_style_01 = object_building_player_shared_player_guildhall_generic_style_01:new {
	...
	shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/house_address_halloween_sign.iff", x = 4.15, z = 1.25, y = 21.5, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "sign_gmf_hanging", suiItem = "@player_structure:halloween_hanging_sign"},
		...
		{templateFile = "object/tangible/sign/player/efol_hanging_sign_01.iff", x = 4.15, z = 1.25, y = 21.5, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "sign_efol_hanging", suiItem = "@player_structure:efol_sign_hanging"},
