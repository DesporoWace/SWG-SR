...
object_building_player_city_cityhall_tatooine = object_building_player_city_shared_cityhall_tatooine:new {
	...
	childObjects = {
		{templateFile = "object/tangible/sign/municipal/municipal_sign_hanging_capitol.iff", x = 0, z = 10.78, y = 16.93, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1},
	...
	shopSigns = {
		{templateFile = "object/tangible/sign/municipal/municipal_sign_hanging_capitol.iff", x = 0, z = 10.78, y = 16.93, ox = 0, oy = -1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "", suiItem = "@player_structure:house_address"},
	},
	alwaysPublic = 1
}
