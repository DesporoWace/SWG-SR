...
object_building_player_player_house_generic_large_style_01 = object_building_player_shared_player_house_generic_large_style_01:new {
	...
	shopSigns = {
		...
		{templateFile = "object/tangible/sign/player/house_address_halloween_sign.iff", x = 11.94, z = 2.25, y = 14.51, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "sign_gmf_hanging", suiItem = "@player_structure:halloween_hanging_sign"},
		...
		{templateFile = "object/tangible/sign/player/efol_hanging_sign_01.iff", x = 11.94, z = 2.25, y = 14.51, ox = 0, oy = 1, oz = 0, ow = 0, cellid = -1, containmentType = -1, requiredSkill = "sign_efol_hanging", suiItem = "@player_structure:efol_sign_hanging"},
		{templateFile = "object/tangible/sign/player/efol_standing_sign_01.iff", x = -3.29, z = 0.5, y = 12.94, ox = 0, oy = 0, oz = 0, ow =  1, cellid = -1, containmentType = -1, requiredSkill = "sign_efol_standing", suiItem = "@player_structure:efol_sign_standing"},
	},
