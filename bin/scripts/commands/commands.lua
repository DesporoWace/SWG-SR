...
--includeFile("../custom_commands/commands.lua")
...
RunSlashCommandsFile("srStaffTools.lua")
...
RunSlashCommandsFile("specialHeavyWeaponCone1.lua")
RunSlashCommandsFile("specialHeavyWeaponCone2.lua")
RunSlashCommandsFile("specialHeavyWeaponSingle1.lua")
RunSlashCommandsFile("specialHeavyWeaponSingle2.lua")
