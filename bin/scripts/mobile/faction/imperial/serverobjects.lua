...
includeFile("faction/imperial/crackdown_elite_dark_trooper_comd.lua")
...
includeFile("faction/imperial/at_at_pvp.lua")
includeFile("faction/imperial/at_st_pvp.lua")
