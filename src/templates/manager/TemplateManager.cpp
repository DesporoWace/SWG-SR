...
#include "templates/tangible/DuplicatorHintTemplate.h"
...
void TemplateManager::registerTemplateObjects() {
	...
	templateFactory.registerObject<DuplicatorHintTemplate>(SharedObjectTemplate::DUPLICATORHINT);
...
void TemplateManager::registerGlobals() {
	...
	luaTemplatesInstance->setGlobalInt("DUPLICATORHINT", SharedObjectTemplate::DUPLICATORHINT);
