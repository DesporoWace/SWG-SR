...
void ObjectManager::registerObjectTypes() {
	...
	objectFactory.registerObject<SeaRemovalFuel>(SceneObjectType::SEAREMOVALFUEL);
	...
	objectFactory.registerObject<FamiliarPetDeed>(SceneObjectType::FAMILIARPETDEED);
