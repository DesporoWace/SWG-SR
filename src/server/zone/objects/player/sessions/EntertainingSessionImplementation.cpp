...
void EntertainingSessionImplementation::doPerformanceAction() {
	...
	int actionDrain = performance->getActionPointsPerLoop() - (int)(entertainer->getHAM(CreatureAttribute::QUICKNESS)/15.f);
...
void EntertainingSessionImplementation::doFlourish(int flourishNumber, bool grantXp) {
	...
	float baseActionDrain = performance->getActionPointsPerLoop() - (int)(entertainer->getHAM(CreatureAttribute::QUICKNESS)/12.5f);
...
void EntertainingSessionImplementation::addEntertainerBuffDuration(CreatureObject* creature, int performanceType, float duration) {
	...
	if (buffDuration > (120.0f + (10.0f / 60.0f) + (float) entertainer->getSkillMod("increase_entertainer_buff")) ) // 2 hrs 10 seconds
		buffDuration = (120.0f + (10.0f / 60.0f) + (float) entertainer->getSkillMod("increase_entertainer_buff")); // 2hrs 10 seconds
